            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-element base-control mb-30">
                        <h4 class="font-20 mb-4">Tambah Service</h4>
                        <!-- Form -->
                        <form action="{{ route('service.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="theme-input-style" name="name" placeholder="Nama Service"
                                    required>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="file" class="theme-input-style" id="password1"
                                    placeholder="Enter your password" name="icon" required>
                            </div>
