            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-element py-30 vertical-form mb-30">
                        ...
                        <!-- Form -->
                        <form action="{{ route('popup.update', ['popup' => $popup->id]) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <!-- Form Group -->
                            <div class="form-group">
                                <img src="{{ asset('storage/popup/' . $popup->image) }}" width="400px" alt=""><br>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="file" name="image" class="form-control pl-1" value="{{ $popup->image }}">
                                </div>
                            </div>
                            <!-- End Form Group -->
